...
class InternalFilterInfo
{
     ...
     * @param AnonymousFunction $filterFunction The anonymous function generated from $filter clause.
     ...
     */
    public function __construct($navigationPropertiesUsedInTheFilterClause, AnonymousFunction $filterFunction, $filterExpAsDataSourceExp, $isCustomExpression)
    {
